...
app.get('/team/:id/:pos', function(req, res){
	...
	console.log(jsonQuery(req.params.id + '.Players[*Position='+ req.params.pos +'].PlayerName',{data:teams}));
	res.status(200).send(jsonQuery(req.params.id + '.Players[*Position='+ req.params.pos +'].PlayerName',{data:teams}).value);
})
